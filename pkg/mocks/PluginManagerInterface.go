...
func (_m *PluginManagerInterface) AddPlugin(ctx *common.Context, plugin system.PluginInterface) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*common.Context, system.PluginInterface) error); ok {
		r0 = rf(ctx, plugin)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *PluginManagerInterface) DiscoverPlugins(ctx *common.Context) ([]system.PluginInterface, error) {
	ret := _m.Called(ctx)
	...
	var r0 []system.PluginInterface
	var r1 error
	if rf, ok := ret.Get(0).(func(*common.Context) ([]system.PluginInterface, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(*common.Context) []system.PluginInterface); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]system.PluginInterface)
		}
	}
...
func (_m *PluginManagerInterface) GetPlugin(name string) (system.PluginInterface, error) {
	ret := _m.Called(name)
	...
	var r0 system.PluginInterface
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (system.PluginInterface, error)); ok {
		return rf(name)
	}
	if rf, ok := ret.Get(0).(func(string) system.PluginInterface); ok {
		r0 = rf(name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(system.PluginInterface)
...
func (_m *PluginManagerInterface) Initialize(ctx *common.Context, _a1 system.SystemInterface) error {
...
func (_m *PluginManagerInterface) LoadRemotePlugin(ctx *common.Context, pluginURL string) (system.PluginInterface, error) {
	...
	var r0 system.PluginInterface
	var r1 error
	if rf, ok := ret.Get(0).(func(*common.Context, string) (system.PluginInterface, error)); ok {
		return rf(ctx, pluginURL)
	}
	if rf, ok := ret.Get(0).(func(*common.Context, string) system.PluginInterface); ok {
		r0 = rf(ctx, pluginURL)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(system.PluginInterface)
...
func (_m *PluginManagerInterface) RemovePlugin(plugin system.PluginInterface) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(system.PluginInterface) error); ok {
		r0 = rf(plugin)
	} else {
		r0 = ret.Error(0)
	}
