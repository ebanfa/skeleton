...
func (_m *ComponentRegistrarInterface) CreateComponent(ctx *common.Context, config *types.ComponentConfig) (types.ComponentInterface, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*common.Context, *types.ComponentConfig) (types.ComponentInterface, error)); ok {
		return rf(ctx, config)
	}
	if rf, ok := ret.Get(0).(func(*common.Context, *types.ComponentConfig) types.ComponentInterface); ok {
		r0 = rf(ctx, config)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*common.Context, *types.ComponentConfig) error); ok {
		r1 = rf(ctx, config)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ComponentRegistrarInterface) GetAllComponents() []types.ComponentInterface {
	...
	var r0 []types.ComponentInterface
	if rf, ok := ret.Get(0).(func() []types.ComponentInterface); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]types.ComponentInterface)
...
func (_m *ComponentRegistrarInterface) GetComponent(id string) (types.ComponentInterface, error) {
	...
	var r0 types.ComponentInterface
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (types.ComponentInterface, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(string) types.ComponentInterface); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.ComponentInterface)
...
func (_m *ComponentRegistrarInterface) GetComponentsByType(componentType types.ComponentType) []types.ComponentInterface {
	...
	var r0 []types.ComponentInterface
	if rf, ok := ret.Get(0).(func(types.ComponentType) []types.ComponentInterface); ok {
		r0 = rf(componentType)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]types.ComponentInterface)
...
func (_m *ComponentRegistrarInterface) GetFactory(id string) (types.ComponentFactoryInterface, error) {
	...
	var r0 types.ComponentFactoryInterface
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (types.ComponentFactoryInterface, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(string) types.ComponentFactoryInterface); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.ComponentFactoryInterface)
		}
	}
...
func (_m *ComponentRegistrarInterface) RegisterFactory(ctx *common.Context, id string, factory types.ComponentFactoryInterface) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*common.Context, string, types.ComponentFactoryInterface) error); ok {
